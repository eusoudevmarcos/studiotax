...
export const CardKanbanClientes: React.FC<TrelloCardProps> = ({
  id,
  title,
  label,
  metadata,
  ...
  return (
    ...
    >
      ...
      <h3 className="font-semibold text-gray-800 mb-2 max-w-[200px] wrap-break-word whitespace-pre-line">
